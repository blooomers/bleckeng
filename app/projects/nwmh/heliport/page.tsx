...
export default function NwmhHeliportPage() {
        ...
        <div className="relative z-10 mx-auto w-full max-w-7xl px-8">
          ...
          <div className="max-w-4xl text-white">
            ...
            <p className="max-w-3xl text-lg font-light leading-relaxed text-white/90">
              This page is a starter for heliport-related scope and coordination
              within the broader campus revitalization effort.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="border-t border-gray-100 bg-white py-16">
        <div className="mx-auto max-w-6xl px-8">
          ...
          <p className="mb-8 text-lg font-light leading-relaxed text-gray-700">
            We’ll expand this page with photos, plan callouts, and a clear
            summary of constraints and coordination needed to keep emergency
            operations accessible during construction.
          </p>
